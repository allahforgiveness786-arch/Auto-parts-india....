...
async function main() {
  ...
  const webDirs = [path.join(__dirname, 'public'), './dist', './src/assets', './react-native-app/src/assets'];
  ...
  const resDirectories = [path.join(__dirname, 'react-native-app/android/app/src/main/res')];
  ...
  for (const resDir of resDirectories) {
    ...
    // Write drawable/launch_screen.xml & ic_notification.xml
    const drawableDir = path.join(resDir, 'drawable');
    if (!fs.existsSync(drawableDir)) fs.mkdirSync(drawableDir, { recursive: true });

    fs.writeFileSync(path.join(drawableDir, 'ic_notification.xml'), `<?xml version="1.0" encoding="utf-8"?>
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <path
        ...
        android:pathData="M12,22c1.1,0 2,-0.9 2,-2h-4c0,1.1 0.9,2 2,2zm6,-6v-5c0,-3.07 -1.63,-5.64 -4.5,-6.32V4c0,-0.83 -0.67,-1.5 -1.5,-1.5s-1.5,0.67 -1.5,1.5v0.68C7.64,4.36 6,6.92 6,10v5l-2,2v1h16v-1l-2,-2z" />
</vector>
`);
